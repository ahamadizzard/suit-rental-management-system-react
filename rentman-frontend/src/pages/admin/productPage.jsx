                                        ...
                                        <div className="space-y-4">
                                            <div className="grid grid-cols-2 gap-4">
                                                <div>
                                                    ...
                                                    <p className="text-gray-900">{selectedProduct.itemCode}</p>
                                                </div>
                                                <div>
                                            ...
                                            <div>
                                                ...
                                                <p className="text-gray-900">{selectedProduct.itemShortName || 'N/A'}</p>
                                            </div>
                                    ...
                                    {selectedProduct && (
                                        <form className="space-y-4">
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    type="text"
                                                    value={selectedProduct.itemShortName || ''}
                                                    onChange={(e) => setSelectedProduct({
                                                        ...selectedProduct,
                                                        itemShortName: e.target.value
                                                    })}
                                                    className="w-full px-3 py-2 border border-gray-300 rounded-md"
                                                />
                                            </div>
